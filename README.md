...
| Graph Lite | Experimental alpha | `dhk graph init/status/index` can scan files, parse Lite nodes/edges, persist snapshot-bound graph rows, and export a local index report. Impact maps are still in progress. |
