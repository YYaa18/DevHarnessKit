    ...
    private static final CliCommandDescriptor[] COMMANDS = new CliCommandDescriptor[]{
            ...
            command("goal", "Run goal orchestration",
                    subcommands("start", "resume", "next", "step", "check", "evaluate", "verify",
                            "audit", "recheck", "retrospective", "review-summary", "mr-summary",
                            "complete", "status", "export", "evidence-template"),
                    options("--project-root", "--goal", "--profile", "--task", "--module", "--mode",
                            "--summary", "--changed-files", "--evidence", "--check", "--all", "--level",
                            "--auto", "--markdown", "--force-new", "--external-ref", "--card-ref", "--write",
                            "--json")),
            ...
            command("context", "Inspect Context Governor artifacts",
                    subcommands("stats", "artifacts", "retrieve", "render", "doctor"),
                    options("--project-root", "--goal", "--limit", "--offset", "--lines", "--type",
                            "--compressor", "--json")),
