...
public final class HelpCommand implements Command {
    public int run(CommandContext context, Args args) {
        ...
        context.out().println("  dhk bdd evidence add --scenario <key> --summary <text>");
        ...
        context.out().println("  .agents/bdd/ stores alpha specification-level scenarios and evidence exports.");
