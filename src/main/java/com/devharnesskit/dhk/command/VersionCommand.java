...
public final class VersionCommand implements Command {
    public int run(CommandContext context, Args args) {
        ...
        context.out().println("stability: stable; experimental surfaces remain outside the stable contract");
        context.out().println("stable_surface: help,version,doctor,memory-core,goal-core,configure,status,readiness,advise,quickstart,release-packaging");
